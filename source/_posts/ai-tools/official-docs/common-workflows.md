...
常见工作流程是日常开发的最佳实践集合，涵盖理解代码库、修复错误、规划任务、管理会话、并行工作等场景。掌握这些流程，能让你更高效地使用 Claude Code。

**上一篇**：[Claude Code 最佳实践](/2026/03/12/ai-tools/official-docs/best-practices/)

**下一篇**：[Claude 如何记住你的项目](/2026/03/12/ai-tools/official-docs/memory/)

---

*本文精读自 [常见工作流程](https://code.claude.com/docs/zh-CN/common-workflows)*
