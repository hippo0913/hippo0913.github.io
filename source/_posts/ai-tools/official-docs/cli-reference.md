...
Claude Code 的 CLI 提供了从简单对话到复杂自动化的全方位能力，掌握常用命令和参数能显著提升你的开发效率。

**上一篇**：[精读官方文档：MCP](https://hippo0913.github.io/2026/03/12/ai-tools/official-docs/mcp/)
**下一篇**：[精读官方文档：Remote Control](https://hippo0913.github.io/2026/03/12/ai-tools/official-docs/remote-control/)

---

*本文精读自 [CLI 参考](https://code.claude.com/docs/zh-CN/cli-reference)*
