---
title: 精读官方文档：CLI 参考
date: 2026-03-12 20:27:00
updated: 2026-03-12 20:27:00
tags: [Claude Code, AI 工具，官方文档精读]
categories: [AI 工具系列]
series: claude-code
series_index: 27
description: 精读 Claude Code 官方文档《CLI 参考》，结合官方最佳实践和 hippo 的真实踩坑经验。
...
根据官方文档，CLI 参考涉及以下关键概念：

1. **核心定义**：CLI 参考是 Claude Code 功能体系中的重要组成部分
...
CLI 参考是 Claude Code 功能体系中的重要组成部分，掌握它能帮助你更高效地使用 Claude Code。
