...
series: claude-code
series_index: 26
description: 精读 Claude Code 官方文档《故障排除》，结合官方最佳实践和 hippo 的真实踩坑经验。
...
1. **核心定义**：故障排除是 Claude Code 功能体系中的重要组成部分
...
故障排除是 Claude Code 功能体系中的重要组成部分，掌握它能帮助你更高效地使用 Claude Code。
