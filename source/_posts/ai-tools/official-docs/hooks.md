...
Hooks 是 Claude Code 的"自动挡"，学会配置和使用 Hooks，就能让 AI 助手自动处理重复性任务，让你专注于真正重要的工作。

**上一篇**：[精读官方文档：MCP 工具参考](/2026/03/10/ai-tools/official-docs/mcp-tools-reference/)

**下一篇**：[精读官方文档：高级功能指南](/2026/03/14/ai-tools/official-docs/advanced-features/)

---

*本文精读自 [Hooks 参考](https://code.claude.com/docs/zh-CN/hooks)*
