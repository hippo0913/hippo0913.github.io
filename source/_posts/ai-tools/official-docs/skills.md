...
**上一篇**：[精读官方文档：Claude 如何记住你的项目](/ai-tools/official-docs/memory/)
**下一篇**：[精读官方文档：Hooks 参考](/ai-tools/official-docs/hooks/)
*本文精读自 [精读官方文档：使用 skills 扩展 Claude - Claude Code Docs](https://code.claude.com/docs/zh-CN/skills)*
