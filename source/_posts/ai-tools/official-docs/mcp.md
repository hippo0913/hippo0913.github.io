...
MCP 让 Claude Code 从"本地工具"升级为"技术中枢"，通过连接数据库、API、监控服务等外部工具，Claude 可以直接操作数据、查询信息、执行任务，极大扩展了其能力边界。

**上一篇**：[使用 skills 扩展 Claude](/2026/03/12/ai-tools/official-docs/skills/)
